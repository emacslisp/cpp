...
*/
#define PATH_LOADSEARCH "/usr/local/share/emacs/24.5/lisp"
...
*/
#define PATH_SITELOADSEARCH "/usr/local/share/emacs/24.5/site-lisp:/usr/local/share/emacs/site-lisp"
...
*/
#define PATH_DUMPLOADSEARCH "/Users/ewu/dev/emacs/emacs-24.5/lisp"
...
#define PATH_EXEC "/usr/local/libexec/emacs/24.5/x86_64-apple-darwin19.6.0"

/* Where Emacs should look for its architecture-independent data
   files, like the NEWS file.  The lisp variable data-directory
   is set to this value.  */
#define PATH_DATA "/usr/local/share/emacs/24.5/etc"
...
#define PATH_DOC "/usr/local/share/emacs/24.5/etc"
